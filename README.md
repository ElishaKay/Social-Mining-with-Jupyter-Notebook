...
Steps 6b: Once you are logged into the iPython notebook, you won't see the original mining the social web package. On your host machine, copy-paste those files into your 'basket4py directory'.
...
Steps 7c: By default the notebooks only allow you to run python 3. You need python 2 to run the "mining the social web" pages.

Once you are sshed into the machine, run these 4 lines:
conda create -n py27 python=2.7
source activate py27
conda install notebook ipykernel
ipython kernel install --user

Now, within your notebook you can toggle between the python 2/3 kernels.
